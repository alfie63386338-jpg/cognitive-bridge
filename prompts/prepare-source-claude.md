# Claude Source Preparation Prompt

This is a convenience wrapper around the canonical generic protocol. Use only Projects, memory/context, conversation history, or uploaded material actually available in this Claude environment. Distinguish direct conversation evidence from your own longitudinal summary.
...
Use only Projects, memory/context, conversation history, or uploaded material actually available in this Claude environment. Distinguish direct conversation evidence from your own longitudinal summary.

Respect every user-specified exclusion and analyze only the explicitly included scope. Do not expand scope merely because additional project, memory, or conversation context is technically accessible.
